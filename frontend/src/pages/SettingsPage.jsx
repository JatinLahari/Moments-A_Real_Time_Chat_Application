              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Jordon Walkie</h3>
                  ...
                  {PREVIEW_MESSAGES.map((msg)=>(
                    <div key={msg.id} className={`flex ${msg.isSent ? "justify-end":"justify-start"}`}>
                      <div className={`max-w-[80%] rounded-xl p-3 shadow-sm ${msg.isSent ? "bg-primary text-primary-content" : "bg-base-200"}`}>
                        ...
                        <p className={`text-[10px] mt-1.5 ${msg.isSent ? "text-primary-content/70":"text-base-content/70"}`}>12:00 PM</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="p-4 border-t border-base-300 bg-base-100">
                  <div className="flex gap-2">
                    ...
                    <button className="btn btn-primary h-10 min-h-0"><Send size={20}/></button>
                  </div>
                </div>
